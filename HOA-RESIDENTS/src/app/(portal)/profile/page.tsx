...
/**
 * Resident self-service account page. Mirrors the ENTERPRISE
 * /settings/profile page exactly so the surface is identical across both
 * portals:
 *   - Identity summary card (avatar + name + email + roles)
 *   - Profile card (firstName / lastName / phone)
 *   - Password card (current + new + confirm)
 *   - Avatar card (via the shared FileUpload primitive)
 */
...
export default function ProfilePage() {
  ...
  const saveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Refresh the AuthProvider's cached user so the topbar name updates
        ...
        <CardContent className="p-6 space-y-5">
          <div>
            ...
            <p className="mt-1 text-caption text-muted-foreground">
              How you appear on invoices, gate-pass alerts, and notices.
            </p>
          </div>
          <form onSubmit={saveProfile} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-caption text-muted-foreground">
                Used for gate-pass SMS and emergency notices when enabled.
              </p>
            </div>
      ...
      <Card>
        <CardContent className="p-6 space-y-5">
          <div>
            ...
            <p className="mt-1 text-caption text-muted-foreground">
              Shown next to your name in the topbar.
            </p>
          </div>
          <FileUpload
            value={avatar}

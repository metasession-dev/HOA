...
/**
 * Sentry + PostHog initialiser for the resident PWA.
 *
 ...
 *
 * Mount once near the root layout, *inside* the AuthProvider so we can
 * identify users as soon as they appear.
 */
...
function initOnce() {
  ...
  if (posthogKey) {
    posthog.init(posthogKey, {
      ...
      // Resident PWA — disable session recording by default; the dashboard
      // operator can flip it on once consent UI exists.

...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('rounded-lg bg-card text-card-foreground shadow-inset-stone', className)}
      {...props}
    />
  ),
);
...
const CardWarm = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('card-warm text-card-foreground', className)}
      {...props}
    />
  ),
);
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('text-heading-sm font-semibold leading-none tracking-tight text-charcoal-primary', className)}
      {...props}
    />
  ),
);
...
export { Card, CardWarm, CardHeader, CardTitle, CardDescription, CardContent, CardFooter };

...
/**
 * Forgot-password — step 1 (resident PWA). Same shape as the ENTERPRISE
 * version; only the `app` hint and brand-panel copy differ. Server never
 * leaks whether the email is on file.
 */
      ...
      <aside className="hidden lg:flex lg:w-1/2 relative overflow-hidden p-12 flex-col justify-between bg-gradient-to-br from-midnight via-charcoal-primary to-graphite">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-4 text-body text-white/75">
            Enter the email your HOA has on file for you. We'll send a one-time
            link that expires in 30 minutes.
          </p>
        </div>

        <p className="relative z-10 text-caption text-white/55">
          Need help? Ask your HOA admin to resend your invite.
        </p>
      </aside>

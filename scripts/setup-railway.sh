...
rv "$ENT_SERVICE" NEXT_PUBLIC_API_URL         "https://\${{ ${API_SERVICE}.RAILWAY_PUBLIC_DOMAIN }}/api"
...
rv "$RES_SERVICE" NEXT_PUBLIC_API_URL         "https://\${{ ${API_SERVICE}.RAILWAY_PUBLIC_DOMAIN }}/api"

 ...
 *
 * Mirrors the HOA-ENTERPRISE primitive exactly; kept in sync so violation
 * appeals, attachments, etc. behave identically across portals.
 *
 * UX:
    ...
    xhr.onload = () => {
      ...
      if (xhr.status >= 200 && xhr.status < 300) {
        try {
          ...
          // Use the latest `value` from the ref at the moment the upload
          // resolves — avoids stale-state races when multiple files upload
          // concurrently.
